...
import plugins.kernel.searchbar.interfaces.SBLink;
...
public class SBDisplay extends JWindow implements CaretListener, ProviderListener
{
    ...
    private static ArrayList<Class<? extends SBProvider>> providerClasses = new ArrayList<Class<? extends SBProvider>>();

    /** Reference to Search Bar */
    private SearchBar sb;

    /** list of all providers */
    private ArrayList<SBProvider> providers = new ArrayList<SBProvider>();

    // /** Animation Timer */
    // private Timer animationTimer;

    /** PopupMenu */
    private JWindow popupMenu;
    ...
    private int previousTimeRequest = 200;
    ...
    private boolean waitingToDisplay;
    ...
    private void updatePopupMenu()
    {
        ...
        {
            popupMenu = tableModel.openPopupMenu(currentRowToolTip);
            if (popupMenu != null)
            {
     ...
     * @param neededSizes
     */
    private void determineDistribution(int[] neededSizes)
    {
     ...
     * @param filter
     */
    private void doRequest(String filter)
    {
     ...
     */
    private synchronized void toSize(final int wantedW, final int wantedH, boolean animate)
    {
     ...
     */
    private synchronized void errorOnline()
    {
        toLoad = 0;
        sb.setLoading(false);
    }
     ...
     */
    public static void registerProvider(Class<? extends SBProvider> providerClass)
    {
     ...
     *        : provider used to get the Class<?> from.
     */
    public static void unregisterProvider(Class<? extends SBProvider> providerClass)
    {
    ...
    public boolean tryFocusLost(MouseEvent e)
    {
        ...
        boolean insidePopupMenu = popupMenu != null && popupMenu.isShowing() && popupMenu.getBounds().contains(p);
