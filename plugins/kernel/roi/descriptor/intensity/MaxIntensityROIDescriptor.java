 ...
 * @author Stephane
 */
public class MaxIntensityROIDescriptor extends ROIDescriptor
{
    public static final String ID = "MaxIntensity";

    public MaxIntensityROIDescriptor()
    {
    ...
    public static double computeMaxIntensity(ROI roi, Sequence sequence) throws UnsupportedOperationException
    {
        try
        {
            return IntensityROIDescriptorsPlugin.computeIntensityDescriptors(roi, sequence).max;
        }
        catch (Exception e)
        {
            return 0d;
