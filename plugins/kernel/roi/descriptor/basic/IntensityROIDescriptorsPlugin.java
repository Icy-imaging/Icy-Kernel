 ...
 * @author Stephane
 */
public class IntensityROIDescriptorsPlugin extends Plugin implements PluginROIDescriptor
{
    public static final String ID_MIN_INTENSITY = MinIntensityROIDescriptor.ID;
    public static final String ID_MEAN_INTENSITY = MeanIntensityROIDescriptor.ID;
    public static final String ID_MAX_INTENSITY = MaxIntensityROIDescriptor.ID;
    public static final String ID_SUM_INTENSITY = SumIntensityROIDescriptor.ID;
    public static final String ID_STANDARD_DEVIATION = StandardDeviationROIDescriptor.ID;

    public static final MinIntensityROIDescriptor minIntensityDescriptor = new MinIntensityROIDescriptor();
    public static final MeanIntensityROIDescriptor meanIntensityDescriptor = new MeanIntensityROIDescriptor();
    public static final MaxIntensityROIDescriptor maxIntensityDescriptor = new MaxIntensityROIDescriptor();
    public static final SumIntensityROIDescriptor sumIntensityDescriptor = new SumIntensityROIDescriptor();
    public static final StandardDeviationROIDescriptor standardDeviationDescriptor = new StandardDeviationROIDescriptor();
