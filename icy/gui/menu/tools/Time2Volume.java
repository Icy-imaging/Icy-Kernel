...
/**
 * Convert a time sequence to a volume sequence with a specific number of Z
 * 
 * @author Fabrice de Chaumont
 */
public class Time2Volume implements ActionListener
{
    IcyFrame mainFrame;
    ...
    public Time2Volume()
    {
        ...
        ThreadUtil.invokeLater(new Runnable()
        {
            ...
            public void run()
            {
                ...
                startButton.addActionListener(Time2Volume.this);
