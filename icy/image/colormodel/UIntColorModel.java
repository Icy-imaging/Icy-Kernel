...
public class UIntColorModel extends IcyColorModel
{
    ...
    {
        super(numComponents, TypeUtil.TYPE_INT, false, bits);
    }
    ...
    public int getRGB(Object pixel)
    {
        ...
        for (int comp = 0; comp < numComponents; comp++)
            scaledData[comp] = (int) colormapScalers[comp].scale(pix[comp] & 0xFFFFFFFFL);
    ...
    public int getRGB(Object pixel, LUT lut)
    {
        ...
        for (int comp = 0; comp < numComponents; comp++)
            scaledData[comp] = (int) lut.getLutBand(comp).getScaler().scale(pix[comp] & 0xFFFFFFFFL);
    ...
    public float[] getNormalizedComponents(Object pixel, float[] normComponents, int normOffset)
    {
        ...
        for (int c = 0, nc = normOffset; c < numComponents; c++, nc++)
            result[nc] = (float) normalScalers[c].scale(data[c] & 0xFFFFFFFFL);
