 ...
 * Icy will always execute them in a separate thread so the interface extends PluginThreaded.<br>
 * They can be enabled / disabled from the Icy preferences window.
 * 
 * @author Stephane
 */
public interface PluginDaemon extends PluginThreaded, Runnable
{
    /**
